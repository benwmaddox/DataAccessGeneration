...
public class FakeDataLookup : IDataLookup
{
    ...
    public List<UserDefinedTableGrouping> GetUserDefinedTypesData = new List<UserDefinedTableGrouping>();
    public List<UserDefinedTableGrouping> GetUserDefinedTypes() => GetUserDefinedTypesData;

    public UserDefinedTableGrouping? GetUserDefinedTypeData = null;
    public UserDefinedTableGrouping? GetUserDefinedType(string schemaName, string udtName) => GetUserDefinedTypeData;
