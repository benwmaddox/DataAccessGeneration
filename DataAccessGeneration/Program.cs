...
namespace DataAccessGeneration
{
    ...
    {
        public const string VERSION = "2023-10-20 V1.28";
        ...
        private static void Run(CommandOptions CLIOptions)
        {
            ...
            var timer = new Timer((callback) => { PrintStatus(generators, stopwatch); }, null, TimeSpan.FromSeconds(1), TimeSpan.FromSeconds(1));
